...
namespace ToDoList.Server.Helpers
{
  public static class ToDoListGenerator
  {
    ...
    public static List<ToDoItem> GenerateRandomItems()
    {
      ...
      lstToDoItems.Add(new ToDoItem { Title = "Walk the dog", CreationDate = DateTime.Now.Date, IsCompleted = true, CompleteBy = DateTime.Now.AddDays(-1).Date, DueBy = DateTime.Now.AddDays(-1).Date });
      ...
      lstToDoItems.Add(new ToDoItem { Title = "Call mum", IsCompleted = true, CreationDate = DateTime.Now.Date, CompleteBy = DateTime.Now.AddDays(-2), DueBy = DateTime.Now.AddDays(-2).Date });
